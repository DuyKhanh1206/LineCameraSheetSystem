...
namespace InterfaceCorpDllWrap
{
	public class IFCDIO_ANY
	{
		...
		public const uint	FBIDIO_IN1_8	= 0;	// Read the data from IN1 through IN8.
		public const uint	FBIDIO_IN9_16	= 1;	// Read the data from IN9 through IN16.
		public const uint	FBIDIO_IN17_24	= 2;	// Read the data from IN17 through IN24.
		public const uint	FBIDIO_IN25_32	= 3;	// Read the data from IN25 through IN32.
		public const uint	FBIDIO_IN33_40	= 4;	// Read the data from IN33 through IN40.
		public const uint	FBIDIO_IN41_48	= 5;	// Read the data from IN41 through IN48.
		public const uint	FBIDIO_IN49_56	= 6;	// Read the data from IN49 through IN56.
		public const uint	FBIDIO_IN57_64	= 7;	// Read the data from IN57 through IN64.


		public const uint	FBIDIO_IN1_16	= 0;	// Read the data from IN1 through IN16.
		public const uint	FBIDIO_IN17_32	= 2;	// Read the data from IN17 through IN32.
		public const uint	FBIDIO_IN33_48	= 4;	// Read the data from IN33 through IN48.
		public const uint	FBIDIO_IN49_64	= 6;	// Read the data from IN49 through IN64.

		public const uint	FBIDIO_IN1_32	= 0;	// Read the data from IN1 through IN32.
		public const uint	FBIDIO_IN33_64	= 4;	// Read the data from IN33 through IN64.

		public const uint	FBIDIO_OUT1_8	= 0;	// Write the data to OUT1 through OUT8.
		public const uint	FBIDIO_OUT9_16	= 1;	// Write the data to OUT9 through OUT16.
		public const uint	FBIDIO_OUT17_24	= 2;	// Write the data to OUT17 through OUT24.
		public const uint	FBIDIO_OUT25_32	= 3;	// Write the data to OUT25 through OUT32.
		public const uint	FBIDIO_OUT33_40	= 4;	// Write the data to OUT33 through OUT40.
		public const uint	FBIDIO_OUT41_48	= 5;	// Write the data to OUT41 through OUT48.
		public const uint	FBIDIO_OUT49_56	= 6;	// Write the data to OUT49 through OUT56.
		public const uint	FBIDIO_OUT57_64	= 7;	// Write the data to OUT57 through OUT64.


		public const uint	FBIDIO_OUT1_16	= 0;	// Write the data to OUT1 through OUT16.
		public const uint	FBIDIO_OUT17_32	= 2;	// Write the data to OUT17 through OUT32.
		public const uint	FBIDIO_OUT33_48	= 4;	// Write the data to OUT33 through OUT48.
		public const uint	FBIDIO_OUT49_64	= 6;	// Write the data to OUT49 through OUT64.

		public const uint	FBIDIO_OUT1_32	= 0;	// Write the data to OUT1 through OUT32.
		public const uint	FBIDIO_OUT33_64	= 4;	// Write the data to OUT33 through OUT64.
		...
		[DllImport("fbidio.dll")]
		public static extern	IntPtr	DioSetBackGroundAny( IntPtr hDeviceHandle, uint dwStartPoint, uint dwPointNum, uint dwValueNum, uint dwCycle, uint dwCount, uint dwOption );
		[DllImport("fbidio.dll")]
