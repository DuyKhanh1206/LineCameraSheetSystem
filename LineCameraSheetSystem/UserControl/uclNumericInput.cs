...
namespace Fujita.InspectionSystem
{
    ...
    public partial class uclNumericInput : UserControl
    {
        private const int FIRST_INCRIMENT_INTERVAL = 300;
        private const int SECOND_INCRIMENT_INTERVAL = 150;

        public event ValueChangeEventHandler ValueChanged = null;
  ...
  //         updateText();
        ...
        private void uclNumericInput_Load(object sender, EventArgs e)
        {
