...
namespace ViewROI
{
    ...
    {
        // 追加
        public bool Initial { get; protected set; }
        ...
        public int RoiType { get; protected set; }

        public int ROI_THUM_SIZE
        {
            get
            {
                string sPath = @".\ViewROI.ini";
                Fujita.Misc.IniFileAccess ini = new Fujita.Misc.IniFileAccess();
                int roiSize = ini.GetIni("ROI_SET", "ROI_THUM_SIZE", _roiThumSize, sPath);
                return roiSize;
            }
            set
            {
                ...
                string sPath = @".\ViewROI.ini";
                Fujita.Misc.IniFileAccess ini = new Fujita.Misc.IniFileAccess();
                ini.SetIni("ROI_SET", "ROI_THUM_SIZE", _roiThumSize, sPath);
            }
        }
        private int _roiThumSize;
        ...
        {
            /*
            System.Reflection.Assembly myAsm = System.Reflection.Assembly.GetEntryAssembly();
            string path = myAsm.Location;
            string ExePath = path.Substring(0, path.LastIndexOf("\\") + 1);
            string sPath = System.IO.Path.Combine(ExePath, "ViewROI.ini");
            */
            //string sPath = @".\ViewROI.ini";
            //Fujita.Misc.IniFileAccess ini = new Fujita.Misc.IniFileAccess();
            ////アプリケーション名
            //int roiSize = ini.GetIni("ROI_SET", "ROI_THUM_SIZE", 16, sPath);
            //ROI_THUM_SIZE = roiSize;
        }
        ...
        /// <summary>Creates a new ROI orgValue</summary>
        ...
        public virtual bool setModelData(HTuple data)
        {
            return false;
        }
