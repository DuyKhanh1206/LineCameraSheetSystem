...
namespace ViewROI
{
    ...
    public class ROIRectangle1 : ROI
    {
        ...
        public ROIRectangle1()
        {
            ...
            RoiType = ROI_TYPE_RECTANGLE1;

            Initial = false;
        }

        public ROIRectangle1(double dRow1, double dCol1, double dRow2, double dCol2)
        {
            NumHandles = 5;
            activeHandleIdx = 4;
        ...
        public override void draw(HalconDotNet.HWindow window)
        {
            ...
            window.DispRectangle2(row1, col1, 0, ROI_THUM_SIZE, ROI_THUM_SIZE);
            window.DispRectangle2(row1, col2, 0, ROI_THUM_SIZE, ROI_THUM_SIZE);
            window.DispRectangle2(row2, col2, 0, ROI_THUM_SIZE, ROI_THUM_SIZE);
            window.DispRectangle2(row2, col1, 0, ROI_THUM_SIZE, ROI_THUM_SIZE);
            window.DispRectangle2(midR, midC, 0, ROI_THUM_SIZE, ROI_THUM_SIZE);
        }
