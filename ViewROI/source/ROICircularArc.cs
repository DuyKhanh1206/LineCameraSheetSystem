...
namespace ViewROI
{
    ...
    public class ROICircularArc : ROI
    {
        ...
        public ROICircularArc()
        {
            ...
            RoiType = ROI_TYPE_CIRCLEARC;

            Initial = false;
        }

        public ROICircularArc(double row, double col, double rad, double startphi, double extentphi)
        {
            NumHandles = 4;         // midpoint handle + three handles on the arc
            activeHandleIdx = 0;
            contour = new HXLDCont();
        ...
        public override void draw(HalconDotNet.HWindow window)
        {
            ...
            window.DispRectangle2(sizeR, sizeC, 0, ROI_THUM_SIZE, ROI_THUM_SIZE);
