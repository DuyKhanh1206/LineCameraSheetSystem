...
namespace ViewROI
{
    ...
    /// </summary>
    public class ROIController : ROI
    {
        ...
        public void paintData(HalconDotNet.HWindow window)
        {
            ...
            if (ROIList.Count > 0)
            {
                ...
                for (int i = 0; i < ROIList.Count; i++)
                {
                    if (((ROI)ROIList[i]).flagLineStyle != null)
                ...
                if (activeROIidx != -1)
                {
                    ...
                    if (((ROI)ROIList[activeROIidx]).flagLineStyle != null)
        ...
        public int mouseDownAction(double imgX, double imgY)
        {
            ...
            double epsilon = ROI_THUM_SIZE * 2;         //maximal shortest distance to one of
                                                        //the handles
